...
export default function Tab() {
  ...
  const fetchOverdueAssignments = async (cookie) => {
    ...
    $('.upcoming-event').each((index, element) => {
  ...
  const fetchUpcomingAssignments = async (cookie) => {
    ...
    upcoming$('.upcoming-event').each((index, element) => {
  ...
  useEffect(() => {
    const cookie = { name: 'SESSb9665c0d9ab149f2bb38695f558551ea', value: '302bf307c6b6844788c3fb2da1f3a25d' };
